...
IMAGE_SIZE = (224, 224)
# CHANGED: Pointing to the final model trained on augmented data
MODEL_PATH = "voting_augmented_model.pkl" 
# CHANGED: Pointing to the final scaler fitted on augmented data
SCALER_PATH = "resnet50_feature_scaler_augmented.pkl" 
...
st.markdown("ระบบจำแนกผลไม้ 4 ชนิด (Apple, Orange, Mango, Banana) โดยใช้เทคนิค Transfer Learning และ Data Augmentation")
